...
{
    dwt_syncrxbufptrs();
//   uint32 id=dwt_read32bitreg(SYS_STATUS_ID);
//   id|=(~SYS_STATUS_RXRFTO);
//   dwt_write32bitoffsetreg(SYS_STATUS_ID,SYS_STATUS_OFFSET,id);
...
//        distance[counter_an-1] =(uint16)(tof * SPEED_OF_LIGHT *100)-50;
