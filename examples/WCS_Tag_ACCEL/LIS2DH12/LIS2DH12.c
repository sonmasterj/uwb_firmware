...
volatile bool boInterruptEvent = false;
...
void vLIS2_EnableWakeUpDetect (void)
{
	...
	vThresholdConfigure (THS_FS2G_32mg, 20, (XHIE | YHIE | ZHIE));
}
...
void vLIS2_EnableInactivityDetect (void)
{
	...
	vThresholdConfigure (THS_FS2G_32mg, 100, (XLIE | YLIE | ZLIE));
}
