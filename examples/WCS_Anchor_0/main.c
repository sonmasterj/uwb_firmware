...
/* time for beacon slot */
#define BN_TIME_SLOT 100*10 //1ms
//--------------dw1000---end---------------
...
//       }
  ...
  if (memcmp(rx_buffer, beacon, ALL_MSG_COMMON_LEN) == 0)
  {
    if(rx_buffer[BN_CLUSTER_NUM]==0)
    {
       printf("init\n");
      tick=0;
      TICK_MAX=10000-20;
...
//    else if(rx_buffer[BN_CLUSTER_NUM]==1)
//    {
//      
//    }
  }
...
//         {
//           time_current=tick;
//           offset=time_current-120;
//           //TICK_MAX=TICK_MAX-offset;
//           printf("%d\n",offset);
//          
//         }
//       }
